...
const HCarousel = () => {
  ...
  return (
    <div className="carousel my-12 mx-auto bg-green p-10">
          ...
          {data.resources.map((resource, index) => {
            return (
              ...
              >
                ...
                <a
                  href={resource.link}
                  className="mx-10 h-full w-full aspect-square block absolute top-0 left-0 transition-opacity duration-300 z-10"
                >
